        ...
        <View style={[
          ...
          <View style={[
            ...
            <View style={{ flex: 6, padding: 4 }} >
              <TextInput
                label="Fluid Handled"
                value={Data.FluidHandled}
                onChangeText={onValueChange("Fluid Handled")}
              />
            </View>

            <View style={{ flex: 6, padding: 4 }} >
              <TextInput
                label="Inlet Temperature [deg/c]"
                keyboardType="numeric"
                value={Data.InletTemperature}
                onChangeText={onValueChange("Inlet Temperature")}
              />
            </View>

            <View style={{ flex: 6, padding: 4 }} >
              <TextInput
                label="Discharge Temperature [deg/c]"
                keyboardType="numeric"
                value={Data.DischargeTemperature}
                onChangeText={onValueChange("Discharge Temperature")}
              />
            </View>

            <View style={{ flex: 6, padding: 4 }} >
              <TextInput
                label="Inlet Pressure [kg/cm2 g]"
                keyboardType="numeric"
                value={Data.InletPressure}
                onChangeText={onValueChange("Inlet Pressure")}
              />
            </View>

            <View style={{ flex: 3, padding: 4 }} >
              <TextInput
                label="Discharge Pressure [kg/cm2 g]"
                keyboardType="numeric"
                value={Data.DischargePressure}
                onChangeText={onValueChange("Discharge Pressure")}
              />
            </View>

            <View style={{ flex: 3, padding: 4 }} >
              <TextInput
                label="Differential Pressure [kg/cm2]"
                keyboardType="numeric"
                value={Data.DifferentialPressure}
                onChangeText={onValueChange("Differential Pressure")}
              />
            </View>
            ...
            <View style={{ flex: 3, padding: 4 }} >
              <TextInput
                ...
                onChangeText={onValueChange("Operation via VFD")}
              />
            </View>
            ...
            <View style={[styles.Gheading, { flex: 3, backgroundColor: '#33ccff', padding: 4 }]}>
              <Text variant="titleMedium">FLUID PARAMETERS</Text>
            ...
            <View style={{ flex: 6, padding: 4 }}>
              <TextInput
                ...
                onChangeText={onValueChange("Relative Humidity ")}
              />
            ...
            <View style={[
              ...
              <View style={[styles.GSubheading, { flex: 6, paddingRight: 2 }]} >
                <Text variant="titleMedium">B L O W E R</Text>
            ...
            <View style={[
              ...
              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  label="Speed of Blower (RPM) [rpm]"
                  value={Data.SpeedOfBlower}
                  onChangeText={onValueChange("SpeedOfBlower")}
                />
              </View>

              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  label="Pulley condition Alignment"
                  value={Data.PulleyconditionAlignment}
                  onChangeText={onValueChange("PulleyconditionAlignment")}
                />
              </View>
              ...
              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  label="Pulley temp"
                  value={Data.Pulleytemp}
                  onChangeText={onValueChange("Pulleytemp")}
                />
              </View>

              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  label="Bearing Oil temp [degC]"
                  keyboardType="numeric"
                  value={Data.BearingOiltempl}
                  onChangeText={onValueChange("BearingOiltemp")}
                />
              </View>

              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  label="V belt Condition"
                  value={Data.VbeltCondition}
                  onChangeText={onValueChange("VbeltCondition")}
                />
              </View>
              ...
              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  ...
                  keyboardType="numeric"
                  value={Data.DirectionofRotation}
                  onChangeText={onValueChange("DirectionofRotation")}
                />
              </View>
              ...
              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  ...
                  keyboardType="numeric"
                  value={Data.NRV}
                  onChangeText={onValueChange("NRV")}
                />
              </View>
              ...
              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  ...
                  keyboardType="numeric"
                  value={Data.Airfiltercondition}
                  onChangeText={onValueChange("Airfiltercondition")}
                />
              </View>
              ...
              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  ...
                  keyboardType="numeric"
                  value={Data.Safetyreliefvalve}
                  onChangeText={onValueChange("Safetyreliefvalve")}
                />
              </View>
              ...
              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  ...
                  keyboardType="numeric"
                  value={Data.AbnormalSound}
                  onChangeText={onValueChange("AbnormalSound")}
                />
              </View>
              ...
              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  label="Hotspots Observed (Using Thermography Scan)"
                  keyboardType="numeric"
                  value={Data.HotspotsObserved}
                  onChangeText={onValueChange("HotspotsObserved")}
                />
              </View>
            </View>
            ...
            <View style={[styles.GSubheading, { flex: 3 }]}>
              <Text variant="titleMedium">P H A S E                 R           Y            B</Text>
            ...
            <View style={{ flex: 3, padding: 4 }}>
              <TextInput
                label="Solo Load Current"
                value={Data.SoloLoadCurrent}
                keyboardType="numeric"
                onChangeText={onValueChange("SoloLoadCurrent")}
              />
            ...
            <View style={{ flex: 3, padding: 4 }}>
              <TextInput
                ...
                keyboardType="numeric"
                value={Data.FullLoadCurrent}
                onChangeText={onValueChange("FullLoadCurrent")}
              />
            ...
            <View style={{ flex: 3, padding: 4 }}>
              <TextInput
                label="Solo Load Voltage"
                keyboardType="numeric"
                value={Data.SoloLoadVoltage}
                onChangeText={onValueChange("SoloLoadVoltage")}
              />
            ...
            <View style={{ flex: 6, padding: 4 }}>
              <TextInput
                ...
                keyboardType="numeric"
                value={Data.NoLoadVoltage}
                onChangeText={onValueChange("NoLoadVoltage")}
              />
            ...
            <View style={{ flex: 6, padding: 4 }}>
              <TextInput
                label="Full Load Voltage"
                keyboardType="numeric"
                value={Data.FullLoadVoltage}
                onChangeText={onValueChange("FullLoadVoltage")}
              />
            ...
            <View style={{ flex: 6, padding: 4 }}>
              <TextInput
                ...
                keyboardType="numeric"
                value={Data.MotorRPM}
                onChangeText={onValueChange("MotorRPM")}
              />
            ...
            <View style={{ flex: 6, padding: 4 }}>
              <TextInput
                ...
                onChangeText={onValueChange("MotorRating")}
              />
            ...
            <View style={{ flex: 6, padding: 4 }}>
              <TextInput
                label="Actual power Consumption [KW]"
                keyboardType="numeric"
                value={Data.ActualpowerConsumption}
                onChangeText={onValueChange("ActualpowerConsumption")}
              />
            ...
            <View style={{ flex: 6, padding: 4 }}>
              <TextInput
                ...
                onChangeText={onValueChange("Frequency")}
              />
          ...
          <View style={[
            ...
            <View style={[styles.Gheading, { flex: 6, backgroundColor: 'cyan' }]}>
              <Text variant="titleMedium">AIR TRIAL</Text>
            </View>
