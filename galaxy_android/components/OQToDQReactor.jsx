        ...
        <View style={[
          ...
          <View style={[
            ...
            <View style={[styles.Gheading, { flex: 6, backgroundColor: 'yellow' }]}>
              <Text variant="titleMedium">O P E R A T I N G    S P E C I F I C A T I O N </Text>
          ...
          <View style={[
            ...
            <View style={[styles.Gheading, { flex: 6, paddingRight: 2, backgroundColor: '#33ccff' }]} >
              <Text variant="titleMedium">UTILITY</Text>

            </View>

            <View style={[styles.Gheading, { flex: 6, paddingRight: 2, backgroundColor: '#33ccff' }]} >
              <Text variant="titleMedium">ENDS</Text>
          ...
          <View style={[
            ...
            <View style={{ flex: 6, padding: 4 }} >
              <TextInput
                label="Contents"
                value={Data.Contents}
                onChangeText={onValueChange("Contents")}
              />
            </View>

            <View style={{ flex: 6, padding: 4 }} >
              <TextInput
                label="Specific gravity of contents"
                keyboardType="numeric"
                value={Data.Specificgravityofcontents}
                onChangeText={onValueChange("Specificgravityofcontents")}
              />
            </View>
            ...
            <View style={{ flex: 6, padding: 4 }} >
              <TextInput
                label="Operating Capacity [m3]"
                keyboardType="numeric"
                value={Data.OperatingCapacity}
                onChangeText={onValueChange("OperatingCapacity")}
              />
            </View>
            ...
            <View style={{ flex: 3, padding: 4 }} >
              <TextInput
                ...
                onChangeText={onValueChange("OperatingTemperature")}
              />
            </View>
            ...
            <View style={[
              ...
              <View style={[styles.GSubheading, { flex: 6, paddingRight: 2 }]} >
                <Text variant="titleMedium">R E A C T O R / V E S S E L</Text>
            ...
            <View style={[
              ...
              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  ...
                  onChangeText={onValueChange("Noise Level")}
                />
              </View>
              ...
              <View style={{ flex: 6, padding: 4 }} >
                <TextInput
                  label="Flusing Plan"
                  keyboardType="numeric"
                  value={Data.FlusingPlan}
                  onChangeText={onValueChange("FlusingPlan")}
                />
              </View>
            ...
            <View style={[
              ...
              <View style={[styles.GSubheading, { flex: 6 }]}>
                <Text variant="titleMedium"> A G I T A T O R     M O T O R</Text>
              </View>
          ...
          <View style={[
            ...
            <View style={[styles.GSubheading, { flex: 3 }]} >
              <Text variant="titleMedium">R E A C T O R</Text>
